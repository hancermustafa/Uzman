...
<style>
    ...
    .stButton>button {
        ...
        border: none; font-weight: bold; height: 3.5em; border-radius: 8px; width: 100%;
        transition: 0.3s;
    }
...
if check_password():
    if os.path.exists("Uzman.png"):
        ...
        st.sidebar.image("https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/Renault_2009_logo.svg/1200px-Renault_2009_logo.svg.png", width=150)
